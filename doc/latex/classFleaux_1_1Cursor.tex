...
\hypertarget{classFleaux_1_1Cursor_a4dcda4244b32b97d7251a64719a348b7}{}\index{Fleaux\+::\+Cursor@{Fleaux\+::\+Cursor}!Cursor@{Cursor}}
...
\item[{bool}]{caller\+Is\+Editor = {\ttfamily false}}
\end{DoxyParamCaption}
)}\label{classFleaux_1_1Cursor_a4dcda4244b32b97d7251a64719a348b7}
Constructor creates a new \hyperlink{classFleaux_1_1Cursor}{Cursor} instance that belongs to the editor pointed to by ed. The optional caller\+Is\+Editor parameter is used to determine if this is being called from an \hyperlink{classFleaux_1_1Editor}{Editor}\textquotesingle{}s constructor, or by another entity. If the call is being made outside of an editor\textquotesingle{}s constructor, then the new cursor is merely a copy of ed\textquotesingle{}s 
